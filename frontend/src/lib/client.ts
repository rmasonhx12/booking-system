...
export function Environment(name: string): BaseURL {
  return `https://${name}-booking-system-rxf2.encr.app`;
}
...
/**
 * Client is an API client for the booking-system-rxf2 Encore application.
 */
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    this.headers = {
      ...
      "User-Agent": "booking-system-rxf2-Generated-TS-Client (Encore/v1.28.0)",
    };
